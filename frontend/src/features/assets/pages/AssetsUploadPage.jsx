...
export function AssetsUploadPage() {
  ...
  const handleContinue = () => {
    ...
    setIsLoading(true);
    navigate("/single-upload/assets/processing", {
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <h1 className="text-3xl font-semibold tracking-tight text-slate-950 dark:text-slate-50">
            Upload an assets dataset
          </h1>
          <p className="mt-2 max-w-2xl text-slate-600 dark:text-slate-400">
            Prepare your CSV for a structured validation pass. Invalid rows are
            removed automatically, then you finalize.
          </p>
        </div>
        ...
        <Card className="space-y-5">
          ...
          <div className="space-y-3 text-sm text-slate-600 dark:text-slate-400">
            <div className="rounded-2xl border border-slate-200 bg-white/70 p-4 dark:border-slate-800 dark:bg-slate-900/60">
              ...
              <p className="mt-1">
                Required headers, primary studio filter, resource type, image
                URLs, and duplicate resource IDs are inspected.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white/70 p-4 dark:border-slate-800 dark:bg-slate-900/60">
              <p className="font-semibold text-slate-900 dark:text-slate-100">
              ...
              <p className="mt-1">
                Invalid full rows are removed during validation — no review step
                for Assets.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white/70 p-4 dark:border-slate-800 dark:bg-slate-900/60">
              ...
              <p className="mt-1">
                Corrected CSVs, removed-row reports, audit trails, and summaries
                are generated for download.
              </p>
            </div>
          </div>
        </Card>
